...
const Select = React.forwardRef(({ dir, ...props }, ref) => (
  <SelectPrimitive.Root dir={dir || (typeof document !== 'undefined' ? document.documentElement.dir || document.body.dir : undefined)} {...props} />
))
