...
export default function ArtStyleSection({ bookData, updateBookData, currentLanguage = "english", isRTL = false }) {
  const [loadingStyles, setLoadingStyles] = useState({});
  const [styleImages, setStyleImages] = useState({
    disney: null, pixar: null, watercolor: null, sketch: null,
    cartoon: null, realistic: null, anime: null, clay: null,
    popup: null, minimalist: null, vintage: null, cultural: null
  });
  ...
  const generateStyleImage = async (style) => {
    ...
    try {
      ...
      let characterDesc = childGender === "boy" ? "a young boy" : childGender === "girl" ? "a young girl" : "a young child";
      ...
      if (result && result.url) {
        ...
        setStyleImages(prev => ({ ...prev, [style]: result.url }));
      }
    } catch (error) {
      // silently handled
    } finally {
  ...
  const artStyles = [
    { id: "disney", title: t("style.disney"), description: t("style.disney.description"), image: styleImages.disney },
    { id: "pixar", title: t("style.pixar"), description: t("style.pixar.description"), image: styleImages.pixar },
    { id: "watercolor", title: t("style.watercolor"), description: t("style.watercolor.description"), image: styleImages.watercolor },
    { id: "sketch", title: t("style.sketch"), description: t("style.sketch.description"), image: styleImages.sketch },
    { id: "cartoon", title: t("style.cartoon"), description: t("style.cartoon.description"), image: styleImages.cartoon },
    { id: "realistic", title: t("style.realistic"), description: t("style.realistic.description"), image: styleImages.realistic },
    { id: "anime", title: t("style.anime"), description: t("style.anime.description"), image: styleImages.anime },
    { id: "clay", title: t("style.clay"), description: t("style.clay.description"), image: styleImages.clay },
    { id: "popup", title: t("style.popup"), description: t("style.popup.description"), image: styleImages.popup },
    { id: "minimalist", title: t("style.minimalist"), description: t("style.minimalist.description"), image: styleImages.minimalist },
    { id: "vintage", title: t("style.vintage"), description: t("style.vintage.description"), image: styleImages.vintage },
    { id: "cultural", title: t("style.cultural"), description: t("style.cultural.description"), image: styleImages.cultural }
  ];

  return (
    <div className="space-y-4 mt-6" dir={isRTL ? "rtl" : "ltr"}>
          ...
          >
            ...
            <div className="p-4 flex-1 flex flex-col">
              <div className="flex items-start gap-3">
                <RadioGroupItem value={style.id} id={`art-style-${style.id}`} className="mt-1" />
                <div className="flex-1">
                  <Label htmlFor={`art-style-${style.id}`} className="text-base font-medium leading-none mb-1 block cursor-pointer">
                    {style.title}
                  </Label>
